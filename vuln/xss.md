...
## Resource
  ...
  |Title|Explanation|
  |---|---|
  |[XSS Blind Stored at 2 Assets TikTok](https://aidilarf.medium.com/xss-blind-stored-at-2-assets-tiktok-f32829f11e58)|Stored XSS, konsistent -> ‘><img src=x onerror=alert()>|
